...
public class PopupManager : MonoBehaviour
{
    ...
    public void ShowAchievementPopup(int index)
    {
        ...
        // 업적 달성 상태 가져오기 (id 기준)
        var status = AchievementManager.Instance.GetStatusById(definition.ach_id);  // 이 메서드는 직접 만들어야 할 수도 있습니다.
        ...
        if (isUnlocked)
        {
            ...
            popupTitleTextType2.text = definition.ach_title;
            popupDescTextType2.text = definition.ach_description;
            /*
        ...
        else
        {
            ...
            popupTitleTextType1.text = definition.ach_title;
            popupDescTextType1.text = definition.ach_description;
